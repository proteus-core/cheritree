...
void LOCATE_FUNC setup_cycle_counterEL1and2_EL1(void)
{
...
//reset counter
void LOCATE_FUNC reset_cycle_counter_EL1(void)
{
	asm volatile(
				 //reset counter
			     //get current register value
...
void LOCATE_FUNC setup_cycle_counterEL1_EL1(void)
{
...
unsigned long int LOCATE_FUNC read_cycle_counter_EL1(void)
{
...
void LOCATE_FUNC enable_cycle_counter_EL1(void)
{
...
void LOCATE_FUNC disable_cycle_counter_EL1(void)
{
	asm volatile(//get current register value
